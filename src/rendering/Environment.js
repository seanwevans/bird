export class Environment {
  constructor({ THREE, CANNON, scene, world, physicsMaterial }) {
    this.THREE = THREE;
    this.CANNON = CANNON;
    this.scene = scene;
    this.world = world;
  ...
  buildGround() {
    ...
    const gridHelper = new this.THREE.GridHelper(10000, 500, 0xffffff, 0xaaaaaa);
  ...
  buildCity(height = 100) {
    ...
    const blockShape = new this.CANNON.Box(new this.CANNON.Vec3(10, height / 2, 10));
